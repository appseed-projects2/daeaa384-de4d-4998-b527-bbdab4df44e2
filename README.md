...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-07-26 01:53`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/daeaa384-de4d-4998-b527-bbdab4df44e2.git
$ cd daeaa384-de4d-4998-b527-bbdab4df44e2
```
